...
// <iframe> 태그만 써도 유튜브 영상 삽입이 가능한데 태그의 속성만으로 커스텀 하기에는 한계가 이음
...
let player;
function onYouTubeIframeAPIReady() { // 라이브러리가 이 함수의 이름을 찾아 실행하기때문에 임의로 바꾸면 안됨
  player = new YT.Player('player', {
    ...
    events: {
      ...
      onReady: function (event) {
        // event.target: 재생되고 있는 영상 자체를 가져옴
